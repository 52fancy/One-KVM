export default {
  ...
  extensions: {
    ...
    frpc: {
      title: 'FRP Client',
      desc: 'NAT penetration via FRP (frpc)',
      ...
      serverAddrRequired: 'Enter the FRP server address',
      serverPort: 'Server Port',
      token: 'Token',
      tokenRequired: 'Enter the FRP authentication token',
      localIp: 'Local IP',
      localPort: 'Local Port',
      remotePort: 'Remote Port',
      remotePortHint: 'Optional. Random if not specified',
